...
def load_model_workflow(i, e, add_name, base_path, device='cpu', eval_addition='', only_inference=True,if_regression=False):
    """
...
def load_model_workflow_reg(i, e, add_name, base_path, device='cpu', eval_addition='', only_inference=True):
    """
    Workflow for loading a model and setting appropriate parameters for diffable hparam tuning.
